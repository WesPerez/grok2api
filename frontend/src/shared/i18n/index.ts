  ...
  "zh-CN": {
    translation: {
      ...
      keys: {
        ...
        modelAliasesBuildSupport: "Grok Build：grok-4.6、grok-4.7 支持 low / medium / high / xhigh；grok-4.5、grok-3-mini、grok-3-mini-fast 支持 low / medium / high。",
        modelAliasesConsoleSupport: "Grok Console：grok-4.6、grok-4.7 支持 low / medium / high / xhigh；grok-4.3 支持 none / low / medium / high；grok-4.20-0309-reasoning 为固定推理模式，不支持调节 effort；grok-4.20-multi-agent-0309 额外支持 xhigh。",
