...
func TestParseReasoningModelAlias(t *testing.T) {
	tests := []struct {
		...
		{name: "grok-4.7 xhigh", input: "Build/grok-4.7-xhigh", wantBase: "Build/grok-4.7", wantLevel: "xhigh", wantOK: true},
		{name: "grok-4.7 rejects max", input: "grok-4.7-max", wantOK: false},
